...
const l = 'undefined' != typeof window ? window : {},
    ...
    const c = t => {
      for (let n = 0; n < t.length; n++)
        (l = t[n]),
          Array.isArray(l)
            ? c(l)
            : null != l && 'boolean' != typeof l && ((s = 'function' != typeof e && !a(l)) && (l += ''), s && o ? (r[r.length - 1].i += l) : r.push(s ? $(null, l) : l), (o = s));
    };
    c(n);
    const i = $(e, null);
    return (i.u = t), r.length > 0 && (i.$ = r), i;
  },
  $ = (e, t) => ({ t: 0, h: e, i: t, p: null, $: null }),
  h = {},
  d = (t, n, l) => {
    let o,
      r,
    ...
    else if (((o = c.p = s.createElement(c.h)), null != e && o['s-si'] !== e && o.classList.add((o['s-si'] = e)), c.$))
      for (i = 0; i < c.$.length; ++i) (r = d(t, c, i)), r && o.appendChild(r);
    return o;
  },
  y = (e, n, l, s, o, r) => {
    let c,
      i = e;
    for (i.shadowRoot && i.tagName === t && (i = i.shadowRoot); o <= r; ++o) s[o] && ((c = d(null, l, o)), c && ((s[o].p = c), i.insertBefore(c, n)));
  },
  p = (e, t, n, l) => {
        ...
        ? ((e, t, n, l) => {
            ...
            for (; o <= c && r <= a; )
              null == i
                ...
                ? (w(u, $), (u = t[--c]), ($ = l[--a]))
                : m(i, $)
                ? (w(i, $), e.insertBefore(i.p, u.p.nextSibling), (i = t[++o]), ($ = l[--a]))
                : m(u, f)
                ? (w(u, f), e.insertBefore(u.p, i.p), (u = t[--c]), (f = l[++r]))
                : ((s = d(t && t[r], n, r)), (f = l[++r]), s && i.p.parentNode.insertBefore(s, i.p));
            o > c ? y(e, null == l[a + 1] ? null : l[a + 1].p, n, l, r, a) : r > a && p(t, o, c);
          })(n, l, t, s)
        : null !== s
        ? (null !== e.i && (n.textContent = ''), y(n, null, t, s, 0, s.length - 1))
        : null !== l && p(l, 0, l.length - 1)
      : e.i !== o && (n.data = o);
  },
  b = (e, t) => {
    ...
    try {
      (l = l.render()),
        ...
        ((n, l) => {
          const s = n.M,
            o = n.k || $(null, null),
            r = (e => e && e.h === h)(l) ? l : f(null, null, l);
          (t = s.tagName), (r.h = null), (r.t |= 4), (n.k = r), (r.p = o.p = s.shadowRoot || s), (e = s['s-sc']), w(o, r);
        })(n, l);
    } catch (e) {
      R(e, n.M);
    }
  ...
  k = e => {
    const t = e.M,
      n = e.S;
    64 & e.t || ((e.t |= 64), O(t), e.v(t), n || v()), e.m && (e.m(), (e.m = void 0)), 512 & e.t && z(() => S(e, !1)), (e.t &= -517);
  },
  v = () => {
    O(s.documentElement),
      z(() =>
  ...
  C = (e, t) => (e && e.then ? e.then(t) : t()),
  O = e => e.classList.add('hydrated'),
  P = (e, t, n) => {
    if (t.C) {
              ...
              set(n) {
                ((e, t, n, l) => {
                  const s = T(e),
                    ...
                    r = s.t,
                    c = s.g;
                  (n = ((e, t) => (null == e || a(e) ? e : 1 & t ? e + '' : e))(n, l.C[t][0])),
                    (8 & r && void 0 !== o) || n === o || (s.O.set(t, n), c && 2 == (18 & r) && S(s, !1));
                })(this, e, n, t);
              },
              configurable: !0,
              enumerable: !0,
  ...
  x = (e, t = {}) => {
    ...
    Object.assign(o, t),
      ...
      (y = !1),
      h.length ? h.map(e => e.connectedCallback()) : o.jmp(() => (d = setTimeout(v, 30)));
  },
  E = new WeakMap(),
  T = e => E.get(e),
  A = (e, t) => E.set((t.g = e), t),
  L = (e, t) => {
    ...
    return (n.T = new Promise(e => (n.v = e))), (e['s-p'] = []), (e['s-rc'] = []), E.set(e, n);
  },
