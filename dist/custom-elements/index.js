...
let Leadclick = class extends HTMLElement {
  ...
  render() {
    ...
    return h(
      ...
      h('p', { class: 'by' }, '\u26A1\uFE0Fby', ' ', h('a', { rel: 'dofollow', target: 'blank', class: 'leadsales_link', href: 'https://leadsales.io/' }, 'leadsales.io')),
    );
  }
...
const LeadclickWidget = /*@__PURE__*/ proxyCustomElement(Leadclick, [
  1,
  'leadclick-widget',
  { cta: [1], instructions: [1], waurl: [1], igurl: [1], fburl: [1], bgcolor: [1], fontcolor: [1], integrations: [2], showOptions: [32] },
]);
const defineCustomElements = opts => {
  if (typeof customElements !== 'undefined') {
    [LeadclickWidget].forEach(cmp => {
