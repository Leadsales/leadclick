...
| `custom_z_index`       | `custom_z_index`       | A custom z-index in case you need to override the default one | `number \| string` | `undefined` |
| `fburl`                | `fburl`                | The Whatsapp url                                              | `string`           | `undefined` |
| `fontcolor`            | `fontcolor`            | The font color                                                | `string`           | `undefined` |
...
| `ispremium`            | `ispremium`            | Whether by leadsales.io copy will be displayed or not         | `boolean`          | `undefined` |
